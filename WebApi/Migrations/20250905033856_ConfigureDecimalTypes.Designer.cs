...
namespace BlueSelfCheckout.WebApi.Migrations
{
    ...
    [Migration("20250905033856_ConfigureDecimalTypes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlueSelfCheckout.WebApi.Models.Customers.CustomerGroup", b =>
                {
                    ...
                    b.ToTable("OCTG", (string)null);
                });

            modelBuilder.Entity("BlueSelfCheckout.WebApi.Models.Orders.Order", b =>
                {
                    ...
                    b.Property<DateTime?>("DocDueDate")
                        .HasColumnType("datetime2")
                        .HasColumnName("DocDueDate");

                    b.Property<decimal?>("DocRate")
                        .HasColumnType("decimal(19,6)")
                        .HasColumnName("DocRate");
                    ...
                    b.Property<string>("FolioNum")
                        ...
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("FolioNum");

                    b.Property<string>("FolioPref")
                        .IsRequired()
                        .HasMaxLength(5)
                        .HasColumnType("nvarchar(5)")
                        .HasColumnName("FolioPref");
                    ...
                    b.ToTable("ORDR", (string)null);
                });

            modelBuilder.Entity("BlueSelfCheckout.WebApi.Models.Orders.OrderLine", b =>
                {
                    b.Property<int>("DocEntry")
                        .HasColumnType("int")
                        .HasColumnOrder(1);
            ...
            modelBuilder.Entity("BlueSelfCheckout.WebApi.Models.Products.ProductAccompaniment", b =>
                {
                    ...
                    b.HasKey("ProductItemCode", "ItemCode");
            ...
            modelBuilder.Entity("BlueSelfCheckout.WebApi.Models.Orders.OrderLine", b =>
                {
                    b.HasOne("BlueSelfCheckout.WebApi.Models.Orders.Order", "Order")
                        .WithMany("OrderLines")
            ...
            modelBuilder.Entity("BlueSelfCheckout.WebApi.Models.Products.ProductAccompaniment", b =>
                {
                    b.HasOne("BlueSelfCheckout.WebApi.Models.Products.Product", "Product")
